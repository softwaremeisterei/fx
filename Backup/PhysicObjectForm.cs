...
{
	/// <summary>
	/// Summary description for PhysicObjectForm.
	/// </summary>
	public class PhysicObjectForm : System.Windows.Forms.Form
	{
		public PhysicObject PhysicObject = new PhysicObject();
		...
		private System.Windows.Forms.TextBox tbOrx;
		private System.Windows.Forms.TextBox tbOry;
		...
		private void btnSave_Click(object sender, System.EventArgs e) {
			...
			this.PhysicObject.Position.X = Double.Parse(this.tbPosx.Text, ns);
			this.PhysicObject.Position.Y = Double.Parse(this.tbPosy.Text, ns);
			this.PhysicObject.Speed = Double.Parse(this.tbSpeed.Text);
			this.PhysicObject.Direction.X = Double.Parse(this.tbOrx.Text, ns);
			this.PhysicObject.Direction.Y = Double.Parse(this.tbOry.Text, ns);
			this.PhysicObject.Mass = Double.Parse(this.tbMass.Text, ns);
			this.Close();
		}

		private void PhysicObjectForm_Load(object sender, System.EventArgs e) {
			this.tbPosx.Text = this.PhysicObject.Position.X.ToString();
			this.tbPosy.Text = this.PhysicObject.Position.Y.ToString();
			this.tbOrx.Text = this.PhysicObject.Direction.X.ToString();
			this.tbOry.Text = this.PhysicObject.Direction.Y.ToString();
			this.tbMass.Text = this.PhysicObject.Mass.ToString();
			this.tbSpeed.Text = this.PhysicObject.Speed.ToString();
